...
func _() {
	...
	_ = x[lbsExtPlayerInfo-39253]
	_ = x[lbsGamePatch-39264]
	_ = x[lbsBattleUserCount-39269]
}

const _CmdID_name = ""
...
var _CmdID_map = map[CmdID]string{
	...
	39253: _CmdID_name[1319:1335],
	39264: _CmdID_name[1335:1347],
	39269: _CmdID_name[1347:1365],
}
