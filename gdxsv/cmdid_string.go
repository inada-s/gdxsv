...
func _() {
	...
	_ = x[lbsExtNotifyMcsStatus-39168]
	_ = x[lbsExtNotifyBattleUsers-39169]
}

const _CmdID_name = ""
...
var _CmdID_map = map[CmdID]string{
	...
	39168: _CmdID_name[1284:1305],
	39169: _CmdID_name[1305:1328],
}
