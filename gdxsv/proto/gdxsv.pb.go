...
var file_gdxsv_proto_gdxsv_proto_rawDesc = []byte{
	...
	0x6f, 0x73, 0x22, 0xf8, 0x02, 0x0a, 0x0d, 0x42, 0x61, 0x74, 0x74, 0x6c, 0x65, 0x4c, 0x6f, 0x67,
	...
	0x0a, 0x62, 0x61, 0x74, 0x74, 0x6c, 0x65, 0x44, 0x61, 0x74, 0x61, 0x12, 0x19, 0x0a, 0x08, 0x73,
	...
	0x18, 0x15, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x65, 0x6e, 0x64, 0x41, 0x74, 0x22, 0x4e, 0x0a,
...
var file_gdxsv_proto_gdxsv_proto_depIdxs = []int32{
	...
	12, // 7: proto.Packet.hello_server_data:type_name -> proto.HelloServerMessage
	10, // 8: proto.Packet.ping_data:type_name -> proto.PingMessage
	11, // 9: proto.Packet.pong_data:type_name -> proto.PongMessage
	9,  // 10: proto.Packet.battle_data:type_name -> proto.BattleMessage
	13, // 11: proto.Packet.fin_data:type_name -> proto.FinMessage
	14, // 12: proto.Packet.hello_lbs_data:type_name -> proto.HelloLbsMessage
